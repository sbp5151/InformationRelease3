 ...
 *
 * @creator boping
 * @create-time 2017/7/7 11:09
 */
public class DayTaskDao {
    private static final String TAG = "DayTaskDao";
    private final DataBaseHelper mDataBaseHelper;
    private Context mContext;
    private static DayTaskDao sDayTaskDao;
    private final Gson mGson;

    private DayTaskDao(Context context) {
    ...
    public static DayTaskDao getInstance(Context context) {
        if (sDayTaskDao == null)
            sDayTaskDao = new DayTaskDao(context);
        return sDayTaskDao;
    }
