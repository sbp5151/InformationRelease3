...
//    public void updateFile(FileRequest body, final IPresenterToModel<BaseResponse> callback, final int requestTag) {
//        LogUtil.d(TAG, "body:" + body);
//        File file = body.getFile();
//        MultipartBody.Part part = prepareFilePart("file", file);
//        mFileService.updateFile(part)
