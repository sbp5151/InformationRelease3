...
public class CountryListView extends RelativeLayout implements OnTouchListener {
	...
	private void init(Context context) {
		...
		lvContries.setDivider(context.getResources().getDrawable(
				R.mipmap.cl_divider));
		adapter = new CountryAdapter(context, lvContries);
		lvContries.setAdapter(adapter);
		LayoutParams lpContries = new LayoutParams(LayoutParams.MATCH_PARENT,
		...
		tvScroll.setTextColor(context.getResources().getColor(
				R.color.white));
