...
import com.jld.InformationRelease.view.my_program.program.adapter.ProgramImageAdapter;
import com.jld.InformationRelease.view.my_program.program.preview.ProgramImagePreview;
...
public class ProgramImageActivity extends BaseProgramCompileActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mProgramBean == null) {
            ...
            mProgramBean.setModelId(Constant.IMAGE_MODEL);
            setTabDialog();
