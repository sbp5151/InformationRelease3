...
import com.jld.InformationRelease.view.my_program.program.preview.ProgramTextPreview;
...
public class ProgramTextActivity extends BaseProgramCompileActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mProgramBean == null) {//新建节目数据
            mProgramBean = new ProgramBean();
            mProgramBean.setModelId(Constant.NAICHA_MODEL_1);
            setTabDialog();
        } else {//再编辑 节目数据
