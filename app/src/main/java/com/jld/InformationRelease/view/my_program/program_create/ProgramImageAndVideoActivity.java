 ...
 * 视频广告  节目编辑
 */
public class ProgramImageAndVideoActivity extends BaseProgramCompileActivity {
...
//            mAddPathPosition = 0;
    ...
    SwipeMenuCreator mSwipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int viewType) {
            ...
            SwipeMenuItem menuItem = new SwipeMenuItem(ProgramImageAndVideoActivity.this)
...
//        intent.addCategory(Intent.CATEGORY_OPENABLE);
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (split[0].equals("video") && (split[1].equals("mp4") || split[1].equals("3gp") || split[1].equals("mov"))) {
                    if (split[0].equals("video") && Integer.parseInt(v_size) / 1024 / 1024 > 100) {
                        ToastUtil.showToast(ProgramImageAndVideoActivity.this, getString(R.string.video_size_too_big), 3000);
                    } else {
                        mAdapter.setPath(mAddPathPosition, v_path);
                    }
                } else
                    ToastUtil.showToast(ProgramImageAndVideoActivity.this, getString(R.string.video_type_nonsupport), 3000);
            ...
            switch (view.getId()) {
                ...
                case R.id.iv_add_video://添加
                    ...
                    if (mAdapter.getItemCount() < 10) {
                        ...
                        ToastUtil.showToast(ProgramImageAndVideoActivity.this, getString(R.string.add_video_max), 3000);
                    break;
    ...
    PopupWindowListener mPopupWindowListener = new PopupWindowListener() {
        ...
        public void onPreview() {
            Intent intent = new Intent(ProgramImageAndVideoActivity.this, ProgramVideoPreview.class);
        ...
        public void onProgramPush() {
            if (getNoNullPath().size() > 0)
                ...
                ToastUtil.showToast(ProgramImageAndVideoActivity.this, getResources().getString(R.string.please_compile), 3000);
        }
    };
}
