package com.jld.InformationRelease.ijk.common;
...
import com.jld.InformationRelease.ijk.media.IRenderView;
import com.jld.InformationRelease.ijk.media.IjkVideoView;
...
//        AndroidMediaController mMediaController = new AndroidMediaController(this.activity, false);
...
//        videoView.setMediaController(mMediaController);
        ...
        videoView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (onUITouchListen != null)
                    onUITouchListen.onSystemUiTouch();
                return false;
            }
        });
    ...
    OnUITouchListen onUITouchListen;

    public void setOnUITouchListen(OnUITouchListen onUITouchListen) {
        this.onUITouchListen = onUITouchListen;
    }

    public interface OnUITouchListen {
        void onSystemUiTouch();
    }
